...
abstract contract ERC1271 {
    ...
    ///         hashStruct(AssociatedAccountRecord({ hash: `hash`}))
    ///      )
    ///
    /// @param hash The original hash.
    ///
    ...
    /// @notice Returns the EIP-712 typed hash of the `AssociatedAccountRecord(bytes32 hash)` data structure.
    ///
    ...
    ///
    /// @param hash The `AssociatedAccountRecord.hash` field to hash.
    ////
    ...
    ///
    /// @param hash The `AssociatedAccountRecord.hash` field.
    ///
